...
public class MyCrawler extends WebCrawler {
        ...
        private static final Pattern taskPatterns = Pattern.compile("task.zhubajie.com", Pattern.CASE_INSENSITIVE);
...
//              return !FILTERS.matcher(href).matches() && href.startsWith("http://www.sandaha.com/weibo/");
        ...
        public void visit(Page page) {
               ...
               // String filename = fmatcher.replaceAll("");
                ...
                //remove '/'
                Pattern fname = Pattern.compile("/");
                Matcher fmatcher = fname.matcher(path);
                String ffname = fmatcher.replaceAll("");
